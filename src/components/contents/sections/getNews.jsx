    ...
    <>
      <section className=" relative flex justify-center items-center w-full h-auto ">
        <div className="static flex flex-col justify-center items-center w-full max-w-[1280px] px-[15px] py-[90px] at500:px-[72px] my-0 mx-auto">
          <div
            data-aos="zoom-in"
            className="bg-[#7D1517] relative flex  justify-center items-center h-auto w-full rounded-[40px]  overflow-hidden"
          >
            <img className="w-full object-cover h-auto" src={shape1} alt="" />
            <img className="w-full object-cover h-auto" src={shape2} alt="" />
            <div className=" absolute flex gap-[20px] flex-col justify-center items-center w-full ">
              <span className="text-[#FFFFFF] txt9">GET THE LATEST NEWS</span>
              <p className="font-Galano text-[16px] text-[#FFFFFF] leading-[24px]">
